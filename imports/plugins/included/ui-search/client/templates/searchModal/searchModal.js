  ...
  this.autorun(() => {
    ...
    if (sub.ready()) {
      ...
      if (searchCollection === "products") {
        ...
        console.log('THESE ARE THE VALUES OF THE PRODUCTS', productResults);
        ...
        console.log('THESE ARE THE HASHTAGS', hashtags);
        console.log('THESE ARE THE TAG RESULTS', tagResults);
