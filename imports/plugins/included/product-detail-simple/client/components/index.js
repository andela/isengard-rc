...
export { default as ShareOnSocial } from "./shareOnSocial";
...
export { default as SubmitReviewContainer } from "./submitReview";
export { default as ProductReviewsContainer } from "./productReviews";
